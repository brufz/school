package br.com.devdojo.awesome.devdojospringboot.security.jwt;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    public JwtAuthFilter(UserServiceImplements userService, JwtService jwtService) {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (authorization != null && authorization.startsWith("Bearer")){
            ...
            if(tokenValid){
                ...
                UserDetails usuario = userService.loadUserByUsername(userLogin);
